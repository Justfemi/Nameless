...
def add_goal(request):
    scrumy = ScrumyGoals.objects.create(goal_name = 'Keep Learning Django', goal_id= gen_id(), moved_by = 'Louis', 
    created_by = 'Louis', owner = 'Louis', goal_status = GoalStatus.objects.get(status_name = 'Weekly Goals'), 
